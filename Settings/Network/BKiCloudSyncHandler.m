...
NSString *BKiCloudContainerIdentifier = @"iCloud.com.teddyku.BlinkShell";
...
//  CKDatabase *database = [[CKContainer containerWithIdentifier:@"iCloud.com.teddyku.BlinkShell"]privateCloudDatabase];
